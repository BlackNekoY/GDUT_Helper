...
public class CircleImageView extends ImageView {
	...
	/**
	 * 之下的四个方法系统在绘制ImageView的时候自动选择调用，例如在配置文件中使用src="@drawable/xxx"
	 * 就会自动调用setImageDrawable方法，重写这些方法可以获取Bitmap或Drawable，来进行初始化
	 */
	@Override
	...
	private void setup() {
		...
		mBorderPaint.setColor(mBorderColor);
		mBorderPaint.setStrokeWidth(mBorderWidth);//Border的宽度就是边距宽度
